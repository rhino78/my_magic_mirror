...
def compliment():
    ...
    morning=['Good morning, handsome!',
            'Enjoy your day!',
            'How was your sleep?',
            'Good morning kids!']

    if currentTime.hour < 12:
        return morning[random.randint(0,len(morning)-1)]
    elif 12 <= currentTime.hour < 18:
        return afternoon[random.randint(0,len(afternoon)-1)]
    else:
        return evening[random.randint(0,len(evening)-1)]
